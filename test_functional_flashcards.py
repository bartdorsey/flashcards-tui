...
from flashcard_types import FlashCard, FlashcardSet, FlashcardSetStats, CardStats, StudySession
from io_operations import (
    load_flashcard_file, load_statistics_file, save_statistics_file,
    discover_flashcard_sets, get_set_display_name, get_set_card_count
)
from flashcard_statistics import (
    update_card_stats, update_set_stats, get_most_challenging_cards,
    calculate_overall_accuracy, calculate_session_summary
)
...
class TestIOOperations:
    ...
    def test_load_flashcard_file_yaml(self, temp_yaml_file):
        ...
        assert flashcard_set.cards[1].question == "What is a Python dictionary?"
    ...
    def test_save_statistics_file(self):
        ...
        try:
            ...
            assert saved_data["flashcard_sets"]["test_set"]["correct_answers"] == 10
        finally:
            os.unlink(temp_file)
...
class TestStatistics:
    ...
    def test_calculate_overall_accuracy(self):
        set_stats = {
            ...
            "legacy_data": FlashcardSetStats(correct_answers=100, total_attempts=200)  # Should be ignored
        }
